...
NAMESPACE="sock-shop"
SERVICES_CSV="carts,user,orders,payment,shipping,front-end,catalogue,queue-master,rabbitmq,orders-db,carts-db,user-db,catalogue-db,payment-db,shipping-db,session-db"
